...
- **Stockhouse.com**: A static website that posts recent news and board announcements. As scraping on most of its pages is allowed, our program will scrap stock press releases from this website.
